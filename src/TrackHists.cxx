...
void TrackHists::fill(const EVENT::Track* track) {
  ...
  h_nhit1->Fill(track->getSubdetectorHitNumbers()[1] +
                track->getSubdetectorHitNumbers()[2]);
  h_nhit2->Fill(track->getSubdetectorHitNumbers()[3] +
                track->getSubdetectorHitNumbers()[4]);
  h_nhit3->Fill(track->getSubdetectorHitNumbers()[5] +
                track->getSubdetectorHitNumbers()[6]);
}
